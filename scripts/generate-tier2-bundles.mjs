...
write(
  `${MGM}/09-tower-facing-groups.csv`,
  replaceSlug(`${SRC_MGM}/tower-facing-groups.csv`, OLD_MGM, NEW_MGM),
);
write(`${MGM}/10-tower-stacks.csv`, replaceSlug(`${SRC_MGM}/tower-stacks.csv`, OLD_MGM, NEW_MGM));
write(
  `${MGM}/11-tower-special-floors.csv`,
  replaceSlug(`${SRC_MGM}/tower-special-floors.csv`, OLD_MGM, NEW_MGM),
);
...
// 09-11 from source with slug fix
write(
  `${PSS}/09-tower-facing-groups.csv`,
  replaceSlug(`${SRC_PSS}/tower-facing-groups.csv`, OLD_PSS, NEW_PSS),
);
write(`${PSS}/10-tower-stacks.csv`, replaceSlug(`${SRC_PSS}/tower-stacks.csv`, OLD_PSS, NEW_PSS));
write(
  `${PSS}/11-tower-special-floors.csv`,
  replaceSlug(`${SRC_PSS}/tower-special-floors.csv`, OLD_PSS, NEW_PSS),
);
