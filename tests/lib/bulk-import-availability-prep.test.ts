...
describe('prepareAvailabilityImportArtifacts', () => {
  it('converts a raw availability sheet into unit import csv and audit artifacts', () => {
    ...
    expect(artifacts.unitsCsv).toContain('create,paragon-signature-suites,TYPE_A,TOWER-1,,A-11-18,11,18,1,646.00');
    ...
    expect(artifacts.auditCsv).toContain('A-11-22,Not Available,RESERVED,Jramin NEG1696,2025-12-13,200.00,MBB');
  });
