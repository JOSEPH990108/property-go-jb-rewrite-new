...
export const TABLE_REGISTRY: Record<string, TableConfig> = {
  // ───── Lookups ─────────────────────────────────────────────────────────────
  propertyCategories: lookupTable(
    "propertyCategories",
    "Property Categories",
  ...
  propertyTypes: lookupTable("propertyTypes", "Property Types", schema.propertyTypes, {
    columnOverrides: {
      ...
      categoryId: {
        label: "Category",
        foreignKey: { table: "propertyCategories", labelColumn: "name" },
      },
    },
  }),
  ...
  constructionStatuses: lookupTable(
    "constructionStatuses",
    "Construction Statuses",
    schema.constructionStatuses,
  ),
  bookingStatuses: lookupTable("bookingStatuses", "Booking Statuses", schema.bookingStatuses),
  appointmentStatuses: lookupTable(
    "appointmentStatuses",
    "Appointment Statuses",
    schema.appointmentStatuses,
  ),
  ...
  developers: {
    ...
    columnOverrides: {
      ...
      logoFileId: {
        label: "Logo File",
        foreignKey: { table: "files", labelColumn: "url" },
        tableHidden: true,
      },
    },
  },
  projects: {
    ...
    columnOverrides: {
      ...
      propertyTypeId: {
        label: "Type",
        foreignKey: { table: "propertyTypes", labelColumn: "name" },
        tableHidden: true,
      },
      projectStatusId: {
        label: "Status",
        foreignKey: { table: "projectStatuses", labelColumn: "name" },
      },
      tenureTypeId: {
        label: "Tenure",
        foreignKey: { table: "tenureTypes", labelColumn: "name" },
        tableHidden: true,
      },
      titleTypeId: {
        label: "Title Type",
        foreignKey: { table: "titleTypes", labelColumn: "name" },
        tableHidden: true,
      },
      ...
      areaId: {
        label: "Area",
        foreignKey: { table: "areas", labelColumn: "name" },
        tableHidden: true,
      },
      address: { label: "Address", fieldType: "textarea", tableHidden: true },
  ...
  projectPhases: {
    ...
    columnOverrides: {
      ...
      constructionStatusId: {
        ...
        foreignKey: { table: "constructionStatuses", labelColumn: "name" },
      },
    },
  },
  projectTowers: {
  ...
  units: {
    ...
    columnOverrides: {
      ...
      layoutId: {
        label: "Layout",
        foreignKey: { table: "projectLayouts", labelColumn: "code" },
        tableHidden: true,
      },
      towerId: {
        label: "Tower",
        foreignKey: { table: "projectTowers", labelColumn: "name" },
        tableHidden: true,
      },
      phaseId: {
        label: "Phase",
        foreignKey: { table: "projectPhases", labelColumn: "name" },
        tableHidden: true,
      },
      ...
      positionTypeId: {
        label: "Position",
        foreignKey: { table: "unitPositions", labelColumn: "name" },
        tableHidden: true,
      },
  ...
  salesPackages: {
    ...
    columnOverrides: {
      ...
      buyerTypeId: {
        label: "Buyer Type",
        foreignKey: { table: "buyerTypes", labelColumn: "name" },
      },
  ...
  rewardConfig: {
    ...
    columnOverrides: {
      ...
      giftId: {
        label: "Gift",
        foreignKey: { table: "giftCatalog", labelColumn: "name" },
        tableHidden: true,
      },
      voucherId: {
        label: "Voucher",
        foreignKey: { table: "voucherCatalog", labelColumn: "name" },
        tableHidden: true,
      },
  ...
  referralRewards: {
    ...
    columnOverrides: {
      ...
      rewardConfigId: {
        label: "Config",
        foreignKey: { table: "rewardConfig", labelColumn: "name" },
        tableHidden: true,
      },
      fulfilledAt: { label: "Fulfilled At", fieldType: "datetime", tableHidden: true },
      fulfilledBy: {
        label: "Fulfilled By",
        foreignKey: { table: "users", labelColumn: "name" },
        tableHidden: true,
      },
  ...
  appointments: {
    ...
    columnOverrides: {
      ...
      statusId: {
        label: "Status",
        foreignKey: { table: "appointmentStatuses", labelColumn: "name" },
      },
      notes: { label: "Notes", fieldType: "textarea", tableHidden: true },
  ...
  projectBankers: {
    ...
    columnOverrides: {
      ...
      bankerId: {
        label: "Banker",
        foreignKey: { table: "panelBankers", labelColumn: "bankerName" },
      },
    },
  },
  packageInventory: {
    ...
    columnOverrides: {
      ...
      inventoryItemId: {
        ...
        foreignKey: { table: "inventoryItems", labelColumn: "name" },
      },
