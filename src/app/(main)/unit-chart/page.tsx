...
export default function UnitChartDemoPage() {
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      {/* Page header */}
      <div className="border-border bg-card/80 border-b backdrop-blur-sm">
        <div className="container py-8">
          <p className="text-primary/80 text-xs font-medium tracking-[0.28em] uppercase">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            {[
              ...
              <div
                key={label}
                className="border-border bg-background rounded-xl border px-4 py-2 text-sm"
              >
      ...
      <div className="container pb-16">
        <div className="border-border bg-card rounded-2xl border p-6">
          <h2 className="text-foreground text-base font-semibold">How to read this chart</h2>
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={label} className="flex gap-3">
                <span className={`mt-0.5 h-5 w-8 shrink-0 rounded border ${color}`} />
                <div>
