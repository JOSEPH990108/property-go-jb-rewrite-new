        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Discover premier properties in Johor Bahru. Your trusted real estate platform for new launches,
              condos, and landed homes.
            </p>
          </div>

          {/* Quick Links */}
          <div className="space-y-3">
            <h4 className="font-semibold text-sm uppercase tracking-wider">Explore</h4>
