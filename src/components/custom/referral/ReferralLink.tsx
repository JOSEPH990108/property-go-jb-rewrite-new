        ...
        <CardContent>
          <div className="flex items-center space-x-2">
            <div className="grid flex-1 gap-2">
              <div className="border-input bg-background flex items-center justify-center rounded-md border px-3 py-3 font-mono text-2xl font-bold tracking-widest shadow-sm">
                {referralCode}
              </div>
            </div>
