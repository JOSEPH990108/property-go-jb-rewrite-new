...
export default function FanCards<T>({
  ...
  return (
    <div className={cn("w-full", className)}>
      {/* Desktop View */}
      <div className="relative hidden h-[550px] w-full items-center justify-center perspective-[1000px] md:flex">
        {items.map((item, index) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                "absolute top-1/2 left-1/2 flex h-[450px] w-[280px] flex-col overflow-hidden rounded-2xl border border-white/10 bg-neutral-900 shadow-2xl transition-colors duration-300",
